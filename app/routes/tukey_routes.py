...
def predict_next_day_tukey():
    ...
    try:
        # **連線到資料庫**
        conn = pymssql.connect(server='hqsbdsql22tv.cpc.com.tw', user=r'cpc\633780', password=r'cpccmsE410206',  database='BDC_TEST')
...
#         server='hqsbdsql22tv.cpc.com.tw', user=r'cpc\633780', password=r'cpccmsE410206',  database='BDC_TEST'
#         )
#         cursor = conn.cursor()
